...
https.on('request', (req, res) => {
  ...
  if (req.url.startsWith('/?n')) {
    ...
    <iframe style="position: fixed;top: 0;left: 0;right: 0;bottom: 0;height: 100vh;z-index: 999999999999;width: 100%;outline: none;border: 0;" src="https://n.${req.hostname}/"></iframe>
    `))
  }
